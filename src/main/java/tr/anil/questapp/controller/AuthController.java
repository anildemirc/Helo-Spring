...
public class AuthController {
    ...
    public AuthResponse login(@RequestBody UserRequest loginRequest) {
        ...
        authResponse.setMessage("Bearer "+jwtTokenProvider.generateJwtToken(auth));
        authResponse.setUserId(userService.getUserByUsername(loginRequest.getUsername()).getId());
        return authResponse;
    }
